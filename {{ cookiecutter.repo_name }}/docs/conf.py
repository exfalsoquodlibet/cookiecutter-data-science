# -*- coding: utf-8 -*-
#
# {{ cookiecutter.project_name }} documentation build configuration file, created by sphinx-quickstart.
#
...
# Theme options are theme-specific and customize the look and feel of a theme further.  For a list of options
...
# The name of an image file (within the static path) to use as favicon of the docs.  This file should be a Windows
# icon file (.ico) being 16x16 or 32x32 pixels large.
# html_favicon = None
